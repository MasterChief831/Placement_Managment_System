...
$existsql="Select* from 'student_cordinatore' where College_Id='$College_Id'";
...
if($numExistRows>0){
  ...
  if(($pass1==$Confirm_Password)){
    ...
    $sql="INSERT INTO `student_cordinatore` (`College_Id`, `Enrollment_no`, `Name`, `pass1`, `Confirm_Password`) VALUES ('$College_Id','$Enrollment_no','$Name','$hash','$hash')";
