            ...
            <div class="col-md-12">
				...
				include 'db_connection.php';
						...
						$sql="select * from came_company";
							...
							echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp package: ".$result['package']."<br>";
							echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp visited: ".$result['date']."<br><br>";
