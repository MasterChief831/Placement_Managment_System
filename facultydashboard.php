        ...
        <!-- Page Heading/Breadcrumbs -->
			...
			<div>
				<form method="POST" action="loginCheck.php" align="center">
					...
					<div class="rows">
							<h4 align="center" style="vertical-align:top"><a href="filter.php">View Student </a></h4>
							<h4 align="center" style="vertical-align:top"><a href="company.html">Add Upcoming Company</a></h4>
							<h4 align="center" style="vertical-align:top"><a href="past_compant.html">Add Came Company</a></h4>
				</div>
				</table>
				</form>
