        ...
        <!-- Page Heading/Breadcrumbs -->
            ...
            <div class="col-md-12">
				...
				include 'db_connection.php';
						// $result5 = $mysqli->query("select * from came_company");
						$sql="select * from company";
							 $query= mysqli_query($conn,$sql);
							 while($result=mysqli_fetch_array($query)) {
							echo "<fieldset>";
							//echo "<div>";
							echo "<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Company Name: ". $result['company_name']."<br>";
							echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Batch: ".$result['batch']."<br>";
							echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Cutoff: ".$result['cgpa']."<br>";
              echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Position: ".$result['role']."<br><br>";
              echo" <button>  <a href=".$result['link'].">Apply</a> </button>";
