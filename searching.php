...
<html lang="en">
	...
	<body background ="images/back.jpg">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                       <a href="Filter.html">Filter_Students</a>
                    </li>
                    <li>
		...
		<div class="row">
			<div class="panel">
				<div class="panel_heading" style="background-color: #ffffff;border-bottom:2px solid #d6d1d1;padding-left:15px; padding-top: 10px;">
					<h4>Search for Students</h4>
				</div>
				<div class="panel-body" style="background-color: #ffffff;">
					<form action="" method="post">
						<input type="text" name="S_cgpa" class="cgpa" placeholder="Search By CGPA"></input>&nbsp&nbsp&nbsp&nbsp
						<input type="text" name="S_Enroll" class="Enroll" placeholder="Search By Enrollment_no"></input>
					</form>
				</div>
        ...
        <!-- Page Heading/Breadcrumbs -->
			<center>
			<table class="table">
				<caption style="text-align: center; font-size:30px; color: #333;">Student Records</caption>
